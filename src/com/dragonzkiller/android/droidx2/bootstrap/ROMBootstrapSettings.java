...
public class ROMBootstrapSettings {
    ...
    public ROMBootstrapSettings() {
        if(SETTINGS_FILE.exists()) {
            ...
            try {
                ...
                if(json.has(INSTALL_CHARGE_KEY)) {
                    mInstallRecovery = json.optBoolean(INSTALL_CHARGE_KEY, true);
                    Log.d(TAG, "Setting [InstallCharge] to [" + (mInstallChargeMode ? "true" : "false") + "]");
                }
            } catch(Exception e) {
    ...
    public boolean installChargeMode() { return mInstallChargeMode; }
}
